...
% I've moved the citation into the sentence to keep it consistent with the rest
% of the report.
% QuantumAnon
...
\begin{proof}
    ...
    % I don't think this lemma is well set out, I'd probably change things to
    %\begin{lemma}[From \textcite[<page_number>]{Bollobas1998}] 
    %  $R(s,t)\leq R(s-1,t)+ R(s,t-1)$
    % QuantumAnon
    % Don't understand the brackets and referencing
    % guglitar
    \end{lemma}
