...
\begin{definition}[Complete graph]
    ...
    We say a graph $G=(V,E)$ is \textit{complete} if $E=[V]^2$. Intuitively, if 
    every pair of vertices has an edge connecting them. We denoted the complete 
...
\begin{definition}[Subgraphs and Cliques]
    ...
    and $E'\subseteq E$. We call $G'$ a \textit{clique} of $G$ if it is complete.
