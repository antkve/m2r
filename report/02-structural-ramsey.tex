...
It is an example of a Fraïssé limit, which is a construction that is found in
model theory.
...
We now focus on the behaviour of finite graphs as structures over a relational
language.
