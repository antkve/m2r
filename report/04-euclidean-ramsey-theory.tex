...
the same choice of scalars by a previous observation. But this contradicts our first Lemma.
...
\begin{definition}[Brick]
    A configuration $\mathfrak{B}$ is a \emph{brick} if $\mathfrak{B} 
    = [B]$ for some $B\in \mathbb{R}^n$ of the form:

    \begin{center}
        $B = \{(b,\cdots,b).\delta \ | \ \delta \in \{0,1\}^n \}$
    \end{center}

    for some $n\in\mathbb{N}$, where $(b,\cdots,b)\in\mathbb{R}^n$ 
    for some fixed $b\in\mathbb{R}\setminus{\{0\}}$.
\end{definition}
