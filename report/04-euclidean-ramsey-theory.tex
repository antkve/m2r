...
These allow us to formulate a necessary condition for a finite set to be Ramsey in $\mathbb{R}^n$.
...
(see \cite{Rado1945}). 
The proof that follows is taken from Graham (see \cite{Graham1981}). In \cite{}  gives a more general proof 
